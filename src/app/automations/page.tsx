              ...
              <div className="p-4 border-b border-border flex items-center justify-between gap-4">
                ...
                {selectedLogs.runs.length > 0 ? (
                  <select
                    ...
                    className="flex-1 max-w-xs px-3 py-2 bg-secondary border border-border text-sm text-foreground focus:outline-none focus:border-foreground appearance-none"
                  >
