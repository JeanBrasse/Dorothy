            ...
            <div className="p-4 border-b border-border flex items-center justify-between gap-3">
              ...
              {selectedLogs.runs.length > 1 && (
                <select
                  ...
                  className="flex-1 min-w-0 px-3 py-2 text-sm bg-secondary border border-border text-foreground focus:outline-none focus:border-foreground appearance-none truncate"
                >
