    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-2xl mx-4 bg-card border border-border rounded-xl overflow-hidden h-[85vh] lg:h-[90vh] flex flex-col [&_button:not(:disabled)]:cursor-pointer"
        >
